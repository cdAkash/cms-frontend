...
const mockStudents = [
  {
    ...
    department: "Mock Department 1",
  },
  {
    id: 2,
    name: "Mock Student 2",
    email: "student2@mock.com",
    department: "Mock Department 2",
  },
];
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setError("An error occurred while fetching the data.Using mock data");
        setData(mockStudents); // Use mock students
      } finally {
        setIsLoading(false);
      }
    };
