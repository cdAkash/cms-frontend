...
const mockDepartments = [
  {
    ...
    deptId: "MD1",
    faculties: ["Mock Faculty 1", "Mock Faculty 2"],
    email: ["faculty1@mock.com", "faculty2@mock.com"],
    isHod: [true, false],
  },
  {
    _id: "2",
    ...
    deptId: "MD2",
    faculties: ["Mock Faculty 3", "Mock Faculty 4"],
    email: ["faculty3@mock.com", "faculty4@mock.com"],
    isHod: [false, true],
  },
];
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      ...
      try {
        ...
        setError("An error occurred while fetching the departments.Using Mock data");
