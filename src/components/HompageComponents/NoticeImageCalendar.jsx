  ...
  const mockNotices = [
    {
      id: 1,
      title: "Mock Notice 1",
      description: "This is a mock notice description.",
      date: "2023-10-01",
      isGlobal: true,
    },
    {
      id: 2,
      title: "Mock Notice 2",
      description: "This is another mock notice description.",
      date: "2023-10-02",
      isGlobal: true,
    },
  ];
  useEffect(() => {
    const fetchNotices = async () => {
      ...
      try {
        ...
        setMessage("An error occurred while fetching the notices. Using Mock data");
